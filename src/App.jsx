...
const DAY_LABELS = [“Sun”,“Mon”,“Tue”,“Wed”,“Thu”,“Fri”,“Sat”];
>>>>>>> 861001efa014f8e23a72ab30599d2830fc38a1ad
const AUDIO_OPTIONS = [
{ id:“none”,    label:“None”,       icon:“🔇” },
...
<style>{` ${settings.reducedMotion?`*,*::before,*::after{animation-duration:0.01ms!important;animation-iteration-count:1!important;transition-duration:0.01ms!important;transition-delay:0ms!important;}`:""} @keyframes slideUp    {from{transform:translateY(100%);opacity:0}to{transform:translateY(0);opacity:1}} @keyframes slideDown  {from{transform:translateY(0);opacity:1}to{transform:translateY(100%);opacity:0}} @keyframes fadeIn     {from{opacity:0;transform:scale(0.96)}to{opacity:1;transform:scale(1)}} @keyframes cardSlideIn  {0%{opacity:0;transform:translateY(16px) scale(0.98)}55%{opacity:1;transform:translateY(-2px) scale(1.003)}100%{opacity:1;transform:translateY(0) scale(1)}} @keyframes cardSlideOut {0%{opacity:1;transform:translateY(0) scale(1)}100%{opacity:0;transform:translateY(10px) scale(0.96)}} @keyframes wrapShrink   {0%{max-height:200px;margin-bottom:9px;opacity:1}30%{opacity:0}100%{max-height:0;margin-bottom:0;opacity:0}} @keyframes noteExpand   {from{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}} @keyframes pulse        {0%,100%{opacity:1}50%{opacity:0.5}} @keyframes burstRipple  {0%{transform:scale(0);opacity:0.9}100%{transform:scale(5);opacity:0}} @keyframes burstFade    {0%{opacity:1}100%{opacity:0}} @keyframes overduePulse {0%,100%{opacity:1}50%{opacity:0.6}} .task-card{transition:opacity 0.3s ease,transform 0.3s cubic-bezier(0.4,0,0.2,1);} .task-wrap{overflow:hidden;} .task-wrap.collapsing{animation:wrapShrink 0.38s cubic-bezier(0.55,0,0.1,1) forwards;pointer-events:none;} .task-wrap.collapsing .task-card{animation:cardSlideOut 0.2s cubic-bezier(0.4,0,1,1) forwards;} .task-card.appearing{animation:cardSlideIn 0.46s cubic-bezier(0.34,1.28,0.64,1) forwards;} .tab-btn{background:none;border:none;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:3px;font-size:10px;font-family:'DM Sans',sans-serif;padding:8px 16px;transition:color 0.2s;color:${th.textDim};} .tab-btn.active{color:${th.text};} .tab-btn.active .tab-icon{transform:scale(1.12);} .tab-icon{font-size:19px;transition:transform 0.2s cubic-bezier(0.34,1.56,0.64,1);display:block;} .action-row:hover{background:${th.surface2} !important;} .toggle-track{cursor:pointer;} input,textarea,select{outline:none;font-family:'DM Sans',sans-serif;} ::-webkit-scrollbar{width:0;} *{-webkit-tap-highlight-color:transparent;} `}</style>
...
<div style={{position:“absolute”,inset:0,background:“rgba(0,0,0,0.75)”,backdropFilter:“blur(8px)”}}/>
<div onClick={e=>e.stopPropagation()} style={{position:“relative”,background:th.surface2,borderRadius:“22px 22px 0 0”,width:“100%”,maxWidth:430,padding:“16px 20px 52px”,maxHeight:“92vh”,overflowY:“auto”,overflowX:“hidden”,animation:“slideUp 0.3s cubic-bezier(0.34,1.08,0.64,1)”,boxShadow:“0 -8px 40px rgba(0,0,0,0.6)”}}>
<style>{`@keyframes dev_slideIn{0%{opacity:0;transform:translateY(18px) scale(0.96)}60%{opacity:1;transform:translateY(-2px)}100%{opacity:1;transform:translateY(0) scale(1)}} @keyframes dev_shrink{0%{opacity:1;transform:scaleY(1)}40%{opacity:0}100%{opacity:0;transform:scaleY(0)}} @keyframes dev_fadeIn{from{opacity:0;transform:scale(0.94)}to{opacity:1;transform:scale(1)}} @keyframes dev_bounce{0%{transform:scale(1)}30%{transform:scale(0.9)}60%{transform:scale(1.08)}100%{transform:scale(1)}}`}</style>
<div style={{width:36,height:4,background:th.border2,borderRadius:2,margin:“0 auto 16px”}}/>
<div style={{display:“flex”,justifyContent:“space-between”,alignItems:“center”,marginBottom:22}}>
<div>
<div style={{fontSize:16,fontWeight:700}}>🛠 Dev Menu</div>
...
<style>{`@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.45}} @keyframes burstRipple{0%{transform:scale(0);opacity:0.85}100%{transform:scale(6);opacity:0}} @keyframes alarmIn{0%{opacity:0;transform:scale(0.88)}60%{transform:scale(1.04)}100%{opacity:1;transform:scale(1)}} @keyframes spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}`}</style>
